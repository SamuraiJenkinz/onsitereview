"""Result formatting utilities for TQRS scoring - Onsite Support Review."""

from tqrs.models.evaluation import CriterionScore
from tqrs.rules.base import RuleResult
from tqrs.scoring.templates import get_criteria, get_criterion_by_id
