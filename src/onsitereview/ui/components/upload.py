"""File upload component for onsitereview Streamlit app."""
...
from onsitereview.ui.state import get_state, has_data, reset_state, set_error, set_success, update_state
...
def _test_llm_connection(state) -> None:
    ...
    from onsitereview.llm.client import OpenAIClient
